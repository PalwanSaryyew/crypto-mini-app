...
interface SignInButtonProps {
    ...
    onSignOut: () => void; // Yeni: Çıkış yapıldığında çağrılacak callback
...
export default function SignInButton({
        ...
        try {
            ...
            WebApp.requestContact(async (hasShared: boolean) => {
                if (hasShared) {
                    ...
                    onSignInError("Telefon numarası paylaşılmadığı için giriş yapılamadı.");
                }
    ...
    const handleSignOut = () => {
        localStorage.removeItem("jwt_token"); // Token'ı kaldır
