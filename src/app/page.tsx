...
export default function HomePage() {
        ...
        const fetchInitData = async () => {
            if (typeof window !== 'undefined') {
                ...
                if (WebApp && WebApp.initData) {
                    ...
                    console.warn("Telegram initData is not available in this environment.");
                }
            }
        };
    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24">
            <h1 className="text-4xl font-bold mb-8">Kripto Uygulamasına Hoş Geldiniz</h1>
            ...
            {token ? (
                ...
                <p className="text-lg text-gray-700">Giriş yapmak için aşağıdaki düğmeyi kullanın.</p>
            )}

            <SignInButton
                onSignInSuccess={handleSignInSuccess}
                onSignInError={handleSignInError}
                onSignOut={handleSignOut} // Çıkış callback'ini gönder
